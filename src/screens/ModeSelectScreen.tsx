      ...
      <div className="mx-auto w-full max-w-6xl px-6 py-10">
        ...
        <div className="mt-8 grid grid-cols-1 gap-6 md:grid-cols-3">
          <Card className="relative overflow-hidden flex flex-col">
            ...
            <CardFooter>
              <Button className="w-full" onClick={() => onSelectMode("country")}>
                시작하기
              </Button>
            </CardFooter>
          </Card>
          ...
          <Card className="relative overflow-hidden flex flex-col">
            ...
            <CardFooter>
              <Button className="w-full" onClick={() => onSelectMode("find-on-map")}>
                시작하기
              </Button>
            </CardFooter>
          </Card>
          ...
          <Card className="relative overflow-hidden flex flex-col">
            <CardHeader>
              ...
              <CardDescription>
                지도를 자유롭게 클릭하거나 목록에서 국가를 선택해 정보를 학습하세요.
              </CardDescription>
            </CardHeader>
            <CardContent className="text-sm text-muted-foreground flex-1">
              - 국가 자유 탐색<br />
            ...
            <CardFooter>
              <Button className="w-full" onClick={() => onSelectMode("learning")}>
                학습하기
              </Button>
            </CardFooter>
          </Card>
